...
st.set_page_config(
    page_title="Atlético Predictor - Interface Avançada",
    layout="wide",
    page_icon="⚽"
)

st.title("⚽ Atlético Predictor - Interface Avançada")
...
# ------------------------
# Próximo jogo e probabilidades à direita
# ------------------------
with col_right:
    ...
    # Modelo simples baseado nas variáveis
    score = (
        xg * 0.4 +
...
# ------------------------
# Calendário de próximos jogos interativo abaixo
# ------------------------
st.header("📅 Calendário de Próximos Jogos")
st.markdown("Clique num jogo acima para destacá-lo à direita.")
...
st.markdown("""
💡 **Observações:**
- Sliders divididos por categorias para facilitar a análise.  
- Gráfico compacto e colorido mostrando probabilidades do próximo jogo.  
- Calendário interativo para destacar o próximo confronto.  
- Mock data por enquanto; será substituído pelos dados reais do FBref na versão completa.
""")
